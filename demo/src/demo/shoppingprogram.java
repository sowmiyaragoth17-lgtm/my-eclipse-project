...
void sekar() {      // method-2
	...
	System.out.print("Enter inhand cash for sekar: ");   // sekar in hand cash--> Rs.375 
	int cash1=obj.nextInt();                            
	 t1=cash1+voucher;     // total amount of sekar= 375+40 =>Rs.415
	System.out.println("Sekar total share is "+t1 );
}
void ram() {         // method-3
	System.out.print("Enter inhand cash for ram: ");  // Ram in hand cash--> Rs.470
...
public static void main(String[]args) {        // main method
	...
	shoppingprogram dis=new shoppingprogram();
	dis.disPart();
	dis.sekar();
	dis.ram();
	dis.finalPayment();
